...
/** @typedef {import("./util/SortableSet")<string>} SortableSetString */
...
class Module extends DependenciesBlock {
	...
	/**
	 * @param {ModuleGraph} moduleGraph the module graph
	 * @returns {false | true | SortableSetString | null} the used exports
	 * false: module is not used at all.
	 * true: the module namespace/object export is used.
	 * SortableSetString: these export names are used.
	 * empty SortableSetString: module is used but no export.
	...
	/**
	 * @param {ModuleGraph} moduleGraph the module graph
	 * @param {false | true | SortableSetString} usedExports the used exports
	 * @returns {void}
	 */
